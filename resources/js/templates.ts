export default [
  {
    ...
    // aiPrompt:
    //   "Generate 5 Blog Topic ideas in bullet points only (no description) based on given niche & outline and give me result in Rich text editor format",
    aiPrompt:
      "Generate Top 5 Blog Topic ideas in bullet points only (no description) based on given niche in Rich text editor format",
...

  {
    ...
    aiPrompt:
      "Generate Blog Content based on topic/niche in rich text editor format",
    form: [
      {
  ...
  {
    name: "Blog Outline",
    desc: "An AI tool that serves as your personal blog post outline writer, generating catchy and viral-worthy titles in your chosen niche.",
    category: "blog",
    icon: "https://cdn-icons-png.flaticon.com/128/4905/4905454.png",
    slug: "blog-outline-generation",
    aiPrompt:
      "Generate Blog Content based on topic/niche and outline in rich text editor format",
    form: [
      {
        label: "Enter your blog topic",
        field: "input",
